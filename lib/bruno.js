export const brunoMessages = {
  ...
  alreadyVerified: [
    "Ah, {name}! I see you're already verified! Go have fun in the server!",
    "Wait, I know you! You're already a certified Brunonian. No need to verify again!",
    "Roar! My favorite verified student {name} is back! What's up?",
    "You're already in the club! No more ID checks for you today, {name}!"
  ],
  codeSent: [
